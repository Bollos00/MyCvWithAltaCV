...
\personalinfo{%
  ...
  \linkedin{bruno-bollos-correa-32b224260}
  \github{Bollos00}
...
\begin{itemize}
  ...
  \item Habilidades: Pesquisa, Python, FastAPI, SQL, Neo4j, Docker, Java, Android, Bluetooth, embarcados (ESP32).
\end{itemize}
